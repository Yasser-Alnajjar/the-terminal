  ...
  "fixed z-50 gap-4 border-border bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full border-e w-3/4 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-sm",
        right:
...
const SheetHeader = ({
  ...
  >
    ...
    <SheetPrimitive.Close asChild>
      <Button size="icon" variant="error" className={closeClassName}>
        <X className="h-4 w-4" />
