...
const inputVariants = cva(
  "flex w-full text-xs rounded-lg  px-4 py-1.5 file:border-0 file:text-sm file:font-medium file:text-foreground placeholder:text-gray-400 focus-visible:outline-none disabled:cursor-not-allowed disabled:bg-gray-100 transition-all duration-200",
  {
    variants: {
      variant: {
        default:
