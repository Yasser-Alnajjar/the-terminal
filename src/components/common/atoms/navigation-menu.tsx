...
const navigationMenuTriggerStyle = cva(
  "group inline-flex w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-[color,box-shadow] outline-none focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "data-[state=open]:bg-primary-400 data-[state=open]:text-white  hover:bg-primary-300 active:bg-primary-500 hover:text-white focus:bg-primary-500 focus:text-white",
...
const navigationMenuLinkVariants = cva(
  "mb-0.5 last:mb-0 text-nowrap relative flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 focus-visible:outline-offset-2 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground focus-visible:ring-primary-400 focus-visible:ring-offset-1",
  {
    variants: {
      variant: {
        default:
          "data-[active=true]:bg-primary-400 data-[active=true]:text-white hover:bg-primary-300 active:bg-primary-500 hover:text-white focus:bg-primary-500 focus:text-white",
