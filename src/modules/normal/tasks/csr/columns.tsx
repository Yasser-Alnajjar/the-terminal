      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="flex gap-2">
            ...
            <div>
              <div
                className="overflow-hidden custom-badge text-xs z-[1] ps-[50px] relative border w-fit px-2 py-1 rounded-md text-center"
                style={{
            ...
            `}</style>
                {row.original.status === "New" ? (
                  <Sparkles
                    className="absolute left-3 top-1/2 -translate-y-1/2 t z-10 text-white"
                    size={12}
                  />
                ) : (
                  <CirclePlay
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                ...
                #{row.original.number} - <p>{row.original.title}</p>
              </div>
